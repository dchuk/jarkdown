...
### Field Coverage
- [ ] **REQ-06**: Full standard field coverage — project, issuelinks, subtasks, time tracking, progress, worklogs, votes, watches, duedate, environment, statusCategory
- [ ] **REQ-07**: Custom field mapping — configurable rendering of customfield_* entries in markdown output

### ADF Parsing
- [ ] **REQ-08**: Complete ADF support — tables, panels, expand blocks, emoji, inline cards, decision items, task lists

### Bulk Operations
- [ ] **REQ-09**: Bulk export — export multiple issues from a list of keys
- [ ] **REQ-10**: JQL query support — accept JQL queries to find and export matching issues

### Tooling
- [ ] **REQ-11**: Migrate to uv package manager — replace pip with uv for cleaner install and usage
